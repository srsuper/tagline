...
from thrift.Thrift import TTypes, TMessageType, TException, TApplicationException
import logging
from TTypes import *
from thrift.Thrift import TProcessor, TType
from thrift.transport import TTransport
from thrift.protocol import TBinaryProtocol, TProtocol
from LineAlpha.LineThrift.ttypes import ChannelException
try:
...
class approveChannelAndIssueChannelToken_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TTypes.STRING, 'channelId', None, None, ), # 1
  )
